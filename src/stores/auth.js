...
const apiKey = 'AIzaSyCHKLOWEAEZ7jxyZ4Ox4UTO6mFvW8ETZ2A'
...
export const useAuthStore = defineStore('auth', () => {
  ...
  const auth = async (payload, type) => {
    ...
    try {
      ...
      // let response = await axiosApiInstance.post(`https://identitytoolkit.googleapis.com/v1/accounts:signInWithCustomToken?key=${apiKey}
      // `, {
      //   ...payload,
      //   returnSecureToken: true
      // });
